...
userRoute.delete("/delete", isAuthenticated, deleteUser);
...
userRoute.get(
  "/reset-password/:id/:token", // if the frontEnd need a validation to display the resetPasswordform
  accessResetForm
);
