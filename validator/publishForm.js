...
const publishForm = [
  body("title")
    .notEmpty()
    .withMessage("Please provide a name title")
    .isLength({ max: 50 })
    .withMessage("Title must be at most 50 characters")
    .custom(fileValidator)
    .withMessage("Only images files are allowed"),
  body("description")
    .notEmpty()
  ...
  body("price")
    ...
    .isFloat({ gt: 500, max: 30000 })
    .withMessage("Price must be greater than 500 and not exceed 30000"),
